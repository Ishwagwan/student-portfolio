...
if 'name' not in st.session_state:
    st.session_state.name = "Ishimwe Kevin"
...
if page == "Home":
    ...
    st.image("me.jpg", width=150, caption="Default image")
...
# Projects section
    ...
    project_data = {
        "Year 1 Project": {
            "📊 Data Analysis Project": {
                "type": "Individual",
                "description": ".",
                "link": "https://https://github.com/e-portofolio-v1"
            }
        },
        "Year 2 Project": {
            "🤖 AI Chatbot": {
                ...
                "link": "https://github.com/Ishimwe Kevin/YEAR-II-C"
            }
        },
        "Year 3 Project": {
            "🌐  Ines Website": {
                ...
                "link": "https://https://github.com//-ines-website"
            }
        },
        "Dissertation": {
            "🌍 Wildlife Safaris Website": {
                ...
                "link": "https://https://github.com//wildlife-safaris-website"
            }
        }
    }
    ...
    testimonials = [
        "Kevin is a brilliant problem solver! His final year project was truly innovative. – Dr. Theodore",
        "Kevin's dedication to AI is inspiring. He never stops learning! – Lecture. Mclement",
...
# Contact section
    ...
    st.markdown("📧 Email:** ishimwekevin108@gmai.com@gmail.com")
    st.markdown("[📂 https://github.com/login")
    st.markdown("[📂 Instagram](https://www.instagram.com/?hl=en)")
...
if page == "Testimonials":
    ...
    st.write("*Kevin is a brilliant problem solver! His final year project is truly innovative. – Mclement*")
